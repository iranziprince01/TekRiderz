  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Tutor Analytics</h1>
          <p className="text-gray-600 mt-2">Your course performance and student insights</p>
        </div>
              ...
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-blue-100 rounded-full">
                    ...
                    {activity.type === 'students' && <Users className="h-4 w-4 text-blue-600" />}
      ...
      <Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {analytics.studentEngagement.map((engagement) => (
            <div key={engagement.courseId} className="p-4 border rounded-lg">
              <h4 className="font-medium text-sm mb-2">{engagement.title}</h4>
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                  <span>Active Students:</span>
                  <span className="font-medium">{engagement.activeStudents}</span>
                </div>
                <div className="flex justify-between text-xs">
                  <span>Avg Time Spent:</span>
                  <span className="font-medium">{engagement.averageTimeSpent.toFixed(1)}h</span>
                </div>
                <div className="flex justify-between text-xs">
                  <span>Avg Progress:</span>
                  <span className="font-medium">{engagement.averageProgress.toFixed(1)}%</span>
                </div>
              </div>
            </div>
          ))}
